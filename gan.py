...
def sample_noise(batch_size, noise_dim, dtype=torch.float, device='cpu'):
  ...
  """
  noise = 1 - 2 * torch.rand(batch_size, noise_dim, device=device)
  ##############################################################################
...
def discriminator_loss(logits_real, logits_fake):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  true_targets = torch.ones_like(logits_real, device=device)
  true_loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_real, true_targets)
  false_targets = torch.zeros_like(logits_fake, device=device)
  false_loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, false_targets)
...
def generator_loss(logits_fake):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  false_targets = torch.ones_like(logits_fake, device=device)
  loss = torch.nn.functional.binary_cross_entropy_with_logits(logits_fake, false_targets)
...
def get_optimizer(model):
  ...
  ##############################################################################
  # Replace "pass" statement with your code
  optimizer = optim.Adam(model.parameters(), lr, betas)
  ##############################################################################
  #                              END OF YOUR CODE                              #
  ##############################################################################
  return optimizer
